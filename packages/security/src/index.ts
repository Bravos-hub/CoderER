...
const rolePermissions: Readonly<Record<ActorRole, readonly CodeerPermission[]>> = {
  ...
  [ActorRole.INCIDENT_COMMANDER]: [
    ...
    IncidentPermission.START_RECOVERY,
    IncidentPermission.READ_RECOVERY,
    IncidentPermission.CANCEL_RECOVERY,
    IncidentPermission.RESUME_RECOVERY,
    IncidentPermission.REQUEST_RECOVERY_REVISION,
    IncidentPermission.APPROVE_RECOVERY_PUBLICATION,
    IncidentPermission.REJECT_RECOVERY_PUBLICATION,
    IncidentPermission.START_PUBLICATION,
    IncidentPermission.READ_PUBLICATION,
    IncidentPermission.CANCEL_PUBLICATION,
    IncidentPermission.RETRY_PUBLICATION,
    IncidentPermission.REQUEST_PUBLICATION_REVISION,
    IncidentPermission.MARK_PUBLICATION_READY,
    IncidentPermission.READ_INCIDENT_CLOSURE,
